...
CRON_JOBS = [
    ...
    {
        "key": "vessel_schedules",
        "name": "Vessel Schedules",
        "log": "/var/log/csl-vessel-schedules.log",
        "success_marker": "Done:",
        "cycle_marker": "Vessel Schedules Monitor",
        "rows_re": re.compile(r"Found (\d+) active shipments"),
        "schedule": "6:00 AM & 12:00 PM M-F",
    },
]
